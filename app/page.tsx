      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            {featuredPost && (
              <article className="group">
                <Link href={`/blog/${featuredPost.slug}`} className="block">
                  ...
                  {/* IMAGE */}
                  <div className="relative w-full h-[420px] overflow-hidden rounded-3xl mb-6 bg-gray-100">
                    <Image
                ...
                {secondaryPosts.map((post) => (
                  <article key={post.slug} className="group">
                    <Link href={`/blog/${post.slug}`} className="block">
                      ...
                      {/* IMAGE */}
                      <div className="relative w-full h-56 overflow-hidden rounded-2xl mb-4 bg-gray-100">
                        <Image
              ...
              <section>
                ...
                <div className="space-y-6">
                  {otherPosts.map((post) => (
                    <article
                      key={post.slug}
                      className="group pb-6 border-b border-gray-100 last:border-0"
                    >
                      <Link href={`/blog/${post.slug}`} className="block">
                        ...
                        <div className="flex gap-5">
                          ...
                          {/* IMAGE */}
                          <div className="relative w-32 h-32 shrink-0 overflow-hidden rounded-2xl bg-gray-100">
                            <Image
                              src={post.image || '/images/default.jpg'}
                              alt={post.title}
                              fill
          ...
          <aside className="lg:col-span-1 space-y-8">
            ...
            {/* About */}
            <div className="border-t-4 border-red-600 bg-gray-50 p-6 rounded-2xl">
